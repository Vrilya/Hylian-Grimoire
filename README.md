...
```text
src/HylianGrimoire.Core/         Testable core library for codecs, ROM workflows, import/export, profiles, services, and domain logic
src/HylianGrimoire/              WinUI 3 desktop application, windows, dialogs, app assets, and UI composition
tests/HylianGrimoire.Tests/      xUnit coverage for codecs, import/export, ROM round-tripping, tools, sessions, and workflow parity
tools/                           Local build, release, verification, and helper scripts
media/                           README screenshots and project media
artifacts/                       Local build/release outputs when generated
```
...
Compression/                     Yaz0 and raw deflate codecs used by ROM compression workflows
Diagnostics/                     Diagnostic log services shared by UI-facing error handling
...
O2r/                             O2R port profiles, archive writing, and resource packing
...
TextTextures/                    Text texture catalogs, settings, renderers, and bitmap helpers
...
```text
Assets/                          Runtime visual, font, texture, and tool assets copied into the app output
Glyphs/                          Glyph Manager window and glyph editing workflows
Interop/                         Windows window theming, icons, sizing, cursor, and native interop helpers
MessageInspector/                Message Byte Inspector window
O2r/                             O2R Mod Maker window and UI workflow
Preview/                         Message preview window and preview UI state
PromptEditor/                    Prompt Editor window and UI workflow
Sessions/                        UI-facing project/session coordination
Soh/                             Ship of Harkinian-oriented UI helpers
TextTextures/                    Text Texture Editor window, settings, preview, and ROM apply workflows
Textures/                        Texture Manager window and UI workflow
TitleText/                       Title Text window and UI workflow
ToolWindows/                     Shared tool-window coordination
Tweaks/                          Tweaks window and UI workflow
```
