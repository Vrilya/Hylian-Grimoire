...
public static partial class RomMessageService
{
    ...
    private static void AddPalFontMessagePointerPatches(
        ...
        MessageEncodingProfile encodingProfile)
    {
        ...
        operations.Add(RomMessagePatchOperation.WriteLuiAddiuAddress(
            rom.Length,
            functionOffset + 0x08,
            functionOffset + 0x0c,
            fontMessageAddress,
            "font-order message pointer"));
        operations.Add(RomMessagePatchOperation.WriteLuiAddiuAddress(
            rom.Length,
            functionOffset + 0x3c,
            functionOffset + 0x44,
            fontMessageEndAddress,
            "font-order message end pointer"));
    }
