...
public static partial class PlaceTitleCardTextureRenderer
{
    private static Bitmap BlurAlphaMask(Bitmap source, double radius)
        => TextTextureBitmapOps.BlurAlphaMask(source, radius, cloneWhenRadiusIsZero: false);
    ...
    private static Bitmap CreateBlankMask()
        => TextTextureBitmapOps.CreateBlankMask(PlaceTitleCardTextureCatalog.Width, PlaceTitleCardTextureCatalog.Height);
}
