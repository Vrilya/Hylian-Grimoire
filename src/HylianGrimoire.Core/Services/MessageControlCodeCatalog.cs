...
public static class MessageControlCodeCatalog
{
    ...
    [
        ...
        [
            ...
            Entry("Event", "[event]", "End with an event-controlled textbox state."),
            Entry("Persistent", "[shop]", "End with a persistent textbox state; used by shop-style text."),
        ...
        new("References",
        [
            ValueEntry("Next Text ID", "[textid:0000]", "Set the next message ID."),
    ...
    [
        ...
        [
            Entry("Line Break", "\n", "Insert a manual line break."),
            Entry("New Textbox", "[break]", "Start a new textbox page."),
            Entry("New Textbox 2", "[break2]", "Start a new textbox page using the BOX_BREAK2 layout adjustment."),
            Entry("Carriage Return", "[carriagereturn]", "Reset horizontal text position without adding newline spacing."),
            Entry("Continue", "[continue]", "End the current message with the continue icon."),
            Entry("Two Choices", "[twochoice]", "Show a two-choice prompt."),
            Entry("Three Choices", "[threechoice]", "Show a three-choice prompt."),
            Entry("Event", "[event]", "End with an event-controlled textbox state."),
            Entry("Event 2", "[event2]", "End with the alternate event-controlled textbox state."),
            Entry("Persistent", "[persistent]", "End with a persistent textbox state."),
            Entry("Background", "[background]", "Draw the Majora's Mask message background command."),
            Entry("Pause Menu", "[pausemenu]", "End with pause-menu textbox behavior."),
        ]),
        ...
        [
            Entry("Quick Text On", "[quicktexton]", "Draw following text instantly."),
            Entry("Quick Text Off", "[quicktextoff]", "Return to normal text drawing."),
            Entry("Text Speed", "[textspeed]", "Insert the MM text-speed marker; this format emits no explicit argument."),
            ValueEntry("Shift", "[shift:00]", "Shift text horizontally by the given pixel amount."),
        ...
        new("Prompts",
        [
            Entry("Bank Input", "[inputbank]", "End with bank rupee input behavior."),
            ...
            Entry("Dog Race Bet", "[inputdogbet]", "End with Doggy Racetrack bet input behavior."),
            Entry("Bomber Code Input", "[inputbombercode]", "End with Bomber Code input behavior."),
            Entry("Lottery Code Input", "[inputlotterycode]", "End with Lottery Code input behavior."),
            ...
            Entry("Owl Warp", "[owlwarp]", "Print the Song of Soaring destination."),
        ]),
