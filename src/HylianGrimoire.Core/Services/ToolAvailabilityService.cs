        ...
        RomMessageData? romData)
    {
        ...
        bool canUseTextTextureEditor = romData is not null
            ...
            && (ItemNameTextureCatalog.TryGetTargets(romData.Profile, out _)
                || MapNameTextureCatalog.TryGetTargets(romData.Profile, out _)
                || MapPositionNameTextureCatalog.TryGetTargets(romData.Profile, out _)
                || MajorasMaskMapNameTextureCatalog.TryGetTargets(romData.Profile, out _)
                || MajorasMaskGameOverTextureCatalog.TryGetTargets(romData.Profile, out _)
                || MajorasMaskPausePromptTextureCatalog.TryGetTargets(romData.Profile, out _)
