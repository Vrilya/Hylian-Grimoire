...
public sealed partial class MainWindow
{
    ...
    private void OpenPreviewWindow()
    {
        if (_previewWindow is null)
        {
            ...
            _previewWindow = MessagePreviewWindowFactory.Create(profile, GetMessagePreviewWindowState(profile.Kind));
    ...
    private MessagePreviewWindowState GetMessagePreviewWindowState(GameKind kind)
    {
        if (!_messagePreviewWindowStates.TryGetValue(kind, out MessagePreviewWindowState? state))
        {
            state = new MessagePreviewWindowState();
            _messagePreviewWindowStates.Add(kind, state);
        }
